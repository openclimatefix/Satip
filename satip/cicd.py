...
def increment_package_version(old_version: str, increment_level: str = "micro"):
    ...
    major, minor, micro = old_version.split(
        "."
    )  # naming from - https://the-hitchhikers-guide-to-packaging.readthedocs.io/en/latest/specification.html#sequence-based-scheme
